...
{
    public partial class CriaTabelasdeEntidadesDeMatricula : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Horario = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HorariosGrade_Horario",
                table: "HorariosGrade",
                column: "Horario",
                unique: true,
                filter: "[Horario] IS NOT NULL");
